   ...
   <div class="max-w-7xl bg-white shadow-lg rounded-lg overflow-hidden mt-10">
      ...
      <form method="post" class="p-8">
         ...
         <div id="id_actividad_actual text-sm">
            <div>
               <label for="id_actividad_actual_0" class="text-sm"><input type="radio" name="actividad_actual" value="trabaja" required="" id="actividad_actual">
                  Trabaja</label>

            </div>
            <div>
               <label for="id_actividad_actual_1" class="text-sm"><input type="radio" name="actividad_actual" value="estudia" required="" id="actividad_actual">
                  Estudia</label>

            </div>
            <div>
               <label for="id_actividad_actual_2" class="text-sm"><input type="radio" name="actividad_actual" value="estudia_y_trabaja" required="" id="actividad_actual">
                  Estudia y trabaja</label>

            </div>
            <div>
               <label for="id_actividad_actual_3" class="text-sm"><input type="radio" name="actividad_actual" value="ni_estudia_ni_trabaja" required="" id="actividad_actual">
